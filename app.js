...
function renderPasien() {
  document.getElementById('app').innerHTML = `
    ...
    <div class="page active" id="pg-beranda">
      ...
      <div class="game-banner" onclick="openGame()" style="background:linear-gradient(135deg,#0B1426,#1a1040);border:1px solid rgba(245,158,11,.3);border-radius:14px;padding:16px;margin-bottom:12px;cursor:pointer;display:flex;align-items:center;gap:14px;transition:all .2s;position:relative;overflow:hidden;">
        <div style="font-size:48px;flex-shrink:0;animation:gfloat 3s ease-in-out infinite;">💎</div>
        <div style="flex:1;">
          <div style="display:inline-block;background:rgba(245,158,11,.2);color:#FCD34D;font-size:10px;font-weight:800;letter-spacing:1px;padding:3px 10px;border-radius:100px;border:1px solid rgba(252,211,77,.3);margin-bottom:6px;">🏆 CRYSTAL QUEST</div>
          <div id="banner-title" style="font-size:16px;font-weight:900;color:white;margin-bottom:4px;">Tap untuk lihat kristal asam uratmu</div>
          <div id="banner-sub" style="font-size:11px;color:rgba(255,255,255,.6);line-height:1.5;">Pantau AU, selesaikan quest, kalahkan Boss!</div>
        </div>
