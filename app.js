...
function renderPasien() {
  document.getElementById('app').innerHTML = `
    <nav class="nav">
      <div class="logo"><div><span class="logo-u">Urat</span><span class="logo-k">Ku</span></div><div style="font-size:8px;color:#9CA3AF;font-weight:500;letter-spacing:0.3px">by dr.andireumato</div></div>
      <div class="nav-tabs">
